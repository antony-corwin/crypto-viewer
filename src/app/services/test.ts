...
//
//   // private _exchanges$: BehaviorSubject<Exchange[]> = new BehaviorSubject<Exchange[]>([]);
//   //
...
//   //     return JSON.parse(<string>localStorage.getItem('assets')).items;
//   //   } else {
//   //     this._metadata_list_assets().subscribe((resp: any) => {
//   //       // localStorage.setItem('assets', JSON.stringify({items: resp}));
//   //       console.log(resp)
//   //       return resp;
//   //     })
//   //   }
...
//   //   } else {
//   //     this._metadata_list_symbols().subscribe((resp: any) => {
...
//     }
//     this._url = "https://rest.coinapi.io";
//
//   }
//
//
//   // private _metadata_list_exchanges() {
//   //   const path = this._url + "/v1/exchanges";
//   //   const options = {headers: this._headers};
//   //
//   //   return this.http.get(path, options);
//   // }
//   //
//   // private _metadata_list_assets() {
//   //   const path = this._url + "/v1/assets";
//   //   const options = {headers: this._headers};
//   //
//   //   return this.http.get(path, options);
//   // }
//   //
//   // private _metadata_list_symbols() {
//   //   const path = this._url + "/v1/symbols"
//   //   const options = {headers: this._headers};
//   //
//   //   return this.http.get(path, options);
//   // }
